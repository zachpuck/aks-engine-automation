...
func TestReconcile(t *testing.T) {
	...
	//instance := &azurev1beta1.AksCluster{ObjectMeta: metav1.ObjectMeta{Name: "foo", Namespace: "default"}}
	//
	...
	//}()
	//
	//// Create the AksCluster object and expect the Reconcile and Deployment to be created
